...
The [JSON report](../public/receipt-demo-v1.json) is a timestamped RPC verification record, not a portable certificate. Devnet can reset, and a later lookup can become unavailable. The payment does not prove the wallets' real-world owners or service delivery. On 23 September 2026, the approved 92.76-second silent product tour was [published on X](https://x.com/NoMotionKol/status/2102829978316657060); it does not show wallet approval. Receivables is listed on the [Hackalaunch public submissions page](https://hackalaunch.com/h/proof-of-taste#submissions). That listing does not establish organizer eligibility or award. See [SUBMISSION.md](SUBMISSION.md) and the dated [verification record](VERIFICATION.md).
