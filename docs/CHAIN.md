...
The [demonstration receipt](https://solana-receivables.vercel.app/demo) was independently checked against Devnet at 23/09/2026 17:11:52 UTC. Signature `KQvP2y2F1RhyzhaU4YNNdhGkpixAUr42KTgWniqnRpnDvbcjYCci6yM4sVJH3GXrbXT1iPpz4qMTzx5iVTJFxwC` matches the canonical request for 1,000,000 lamports, recipient `2Ga88akVcu85SpbRxCHQkdQyU1jbvve6cMaYWyW1YDh1`, payer `8PQiZb87dzMynLPM3K4Ph6bVNDoFTfyg34rMsEjAHCeb` and a 5,000-lamport fee in slot 503047831. The [public JSON report](../public/receipt-demo-v1.json) records the check time and links; a later viewer should requery Devnet. This proves a test transfer matching that request, not wallet identity, fulfillment or Mainnet payment.
...
Production is live at https://solana-receivables.vercel.app. Vercel reported READY for historical commit `46403d3`; CI passed the build, 25 tests and dependency import guard (run [35817868974](https://github.com/Miervolino06/solana-receivables/actions/runs/35817868974)). At 01:20 BRT on 23/09/2026, production smoke checks returned OPTIONS 204, GET 200 with a 0.000005 SOL network fee and 0.001005 SOL total for a 0.001 SOL request, invalid-payer POST 400, icon 200 and actions.json 200. That earlier smoke verified deployment routes and validation behavior without submitting a transaction; the independently verified payment above happened later. No external client rendering or verified registry listing is claimed.
